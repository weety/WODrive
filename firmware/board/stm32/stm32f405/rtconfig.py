...
if PLATFORM == 'gcc':
    ...
    LFLAGS = DEVICE + ' --scatter "board\linker_scripts\link.sct" --info sizes --info totals --info unused --info veneers --list WODriveFirmware.map --strict'
    ...
    POST_ACTION = 'fromelf --bin $TARGET --output WODriveFirmware.bin \nfromelf -z $TARGET'
    ...
    LFLAGS += ' --list WODriveFirmware.map '
    ...
    POST_ACTION = 'ielftool --bin $TARGET WODriveFirmware.bin'

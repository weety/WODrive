...
#define UART_INTF_DEV_NAME "uart4"

// Thread prority config
#define COMM_THREAD_PRIO  15
#define COMM_UART_THREAD_PRIO 16
#define COMM_CAN_THREAD_PRIO 16
#define HMI_THREAD_PRIO 20
#define AXIS0_THREAD_PRIO 1
#define AXIS1_THREAD_PRIO 0
#define ANALOG_POLL_THREAD_PRIO 25
